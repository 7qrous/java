...
public class ChatClient {
    ...
    public ChatClient() {
        ...
        joinButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                String channel = JOptionPane.showInputDialog(frame, "Enter channel to join:");
        ...
        createButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                String channel = JOptionPane.showInputDialog(frame, "Enter channel name to create:");
                if (channel != null && !channel.trim().isEmpty()) {
                    sendMessage("/create " + channel);
                }
            }
        });
